...
public class VideoResponse implements Serializable
{
    ...
    @JsonProperty("list")
    private java.util.List<aiss.dailymotion_Miner.model.dailymotion.Video> list;
    private final static long serialVersionUID = -6491881872535539779L;
    ...
    @JsonProperty("list")
    public java.util.List<aiss.dailymotion_Miner.model.dailymotion.Video> getList() {
        return list;
    }

    @JsonProperty("list")
    public void setList(java.util.List<aiss.dailymotion_Miner.model.dailymotion.Video> list) {
        this.list = list;
    }

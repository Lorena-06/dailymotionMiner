...
public class CaptionResponse {
    ...
    @JsonProperty("list")
    private java.util.List<aiss.dailymotion_Miner.model.dailymotion.Caption> list;
    ...
    @JsonProperty("list")
    public java.util.List<aiss.dailymotion_Miner.model.dailymotion.Caption> getList() {
        return list;
    }

    @JsonProperty("list")
    public void setList(java.util.List<aiss.dailymotion_Miner.model.dailymotion.Caption> list) {
        this.list = list;
    }

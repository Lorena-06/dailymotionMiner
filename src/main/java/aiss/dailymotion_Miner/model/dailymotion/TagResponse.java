...
public class TagResponse implements Serializable {
    ...
    @JsonProperty("list")
    private java.util.List<Tag> list;
    ...
    @JsonProperty("list")
    public java.util.List<Tag> getList() {
        return list;
    }

    @JsonProperty("list")
    public void setList(java.util.List<Tag> list) {
        this.list = list;
    }
    ...
    public String toString() {
        ...
        sb.append(TagResponse.class.getName()).append('@').append(Integer.toHexString(System.identityHashCode(this))).append('[');
        sb.append("page");
        sb.append('=');
